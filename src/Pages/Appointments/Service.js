...
const Service = ({service, setTreatment}) => {
    ...
    return (
        <div className='rounded-[18px] p-[25px] shadow-xl'>
            ...
            <label  className="btn btn-primary text-white font-bold bg-gradient-to-r from-secondary to-primary" disabled={slots.length===0} htmlFor="booking-modal" onClick={()=>setTreatment(service)}>book appointments</label>
        </div>
    );
};
